...
The package provides an RStudio add-in "Convert to cli" that we suggest registering with the keybinding "Ctrl+Shift+C". To do so, navigate to Tools > Modify Keyboard Shortcuts > Search "Convert to cli", and add the keybinding. After selecting some code, press the keyboard:
